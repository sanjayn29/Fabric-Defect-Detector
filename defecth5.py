# fabric_defect_detector_pi_h5.py
import cv2
import numpy as np
...
# Constants
#MODEL_PATH = 'fabric_defect_model.h5'  # Changed to .h5 model
...
def predict_with_tta(frame, n_augment=3):
    ...
    base_pred = model.predict(original, verbose=0)
...
def main():
    ...
    print("Fabric Defect Detector Running (H5 Model)...")
    ...
    while True:
        ...
        cv2.imshow('Fabric Defect Detector (H5)', frame)
